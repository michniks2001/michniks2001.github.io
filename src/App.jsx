import { ChakraProvider, Box, Container, Heading, Text, VStack, HStack, Icon, useColorMode, IconButton, Flex, Badge, Link } from '@chakra-ui/react'
import { motion } from 'framer-motion'
import { SunIcon, MoonIcon } from '@chakra-ui/icons'
import { FaGithub, FaLinkedin, FaReact, FaNode, FaStripe, FaDiscord, FaExternalLinkAlt } from 'react-icons/fa'
...
function App() {
  ...
  const ProjectCard = ({ title, description, features, isAward, githubLink }) => (
      <MotionBox
      ...
      >
        ...
        {githubLink && (
            <Link href={githubLink} isExternal mt={3} display="inline-flex" alignItems="center">
              <Icon as={FaGithub} mr={1} />
              <Text fontSize="xs">View on GitHub</Text>
              ...
              <VStack spacing={4} align="center" mb={10}>
                ...
                <HStack spacing={4}>
                  <MotionBox whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }}>
                    <Link href="https://github.com/michniks2001" isExternal>
                      <Icon
                          as={FaGithub}
                          boxSize={6}
                          cursor="pointer"
                  ...
                  <MotionBox whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }}>
                    <Link href="https://linkedin.com/in/samuel-michnik" isExternal>
                      <Icon
                          as={FaLinkedin}
                          boxSize={6}
                          cursor="pointer"
                ...
                >
                  <Box flex={["1 1 100%", "1 1 100%", "1 1 31%"]}>
                    <ProjectCard
                        ...
                        githubLink="https://github.com/michniks2001/clarityai"
                    />
                  </Box>
                  <Box flex={["1 1 100%", "1 1 100%", "1 1 31%"]}>
                    <ProjectCard
                        ...
                        isAward={true}
                        githubLink="https://github.com/michniks2001/social-hackathon"
                    />
                  </Box>
                  <Box flex={["1 1 100%", "1 1 100%", "1 1 31%"]}>
                    <ProjectCard
                        ...
                        githubLink="https://github.com/michniks2001/ingredientbud-io"
                    />
                  </Box>
                </Flex>
              </VStack>
